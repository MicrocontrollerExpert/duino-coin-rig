...
String configStatus             = "";
String wifiSsid                 = "WLAN-TCOM1";                         // Your WiFi SSID
String wifiPassword             = "2806197828061978";                         // Your WiFi password
String nameUser                 = "DerProgrammierer78";                         // Your Duino Coin username
...
uint16_t serverPoolPort           = 6000;                         // The port to connect to
